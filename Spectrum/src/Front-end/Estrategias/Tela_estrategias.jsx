       ...
       <Navbar_estrategias/>
        ...
        <div className="elements_texts_topicos_estrategias">
          <div className="elements_texts_estrategias">
            ...
            <h2 className="text_sons_altos_estrategias">Lidar com sons autos pode ser particularmente desafiador para pessoas autistas, mas algumas 
            estratégias podem ajudar a minimizar o desconforto:</h2>
          </div>
          <div className="container_buttons_style_estrategias">
            <button className="buttons_style_estrategias">Protetores Auriculares</button>
